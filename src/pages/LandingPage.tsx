          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="flex flex-col justify-center">
              ...
              >
                <Link 
                  to="/register" 
                  className="px-8 py-4 bg-primary-600 text-white rounded-md text-center hover:bg-primary-700 transition-colors group"
                >
                ...
                <a 
                  href="#demo" 
                  className="px-8 py-4 border border-gray-300 text-gray-700 rounded-md text-center hover:bg-gray-50 transition-colors flex items-center justify-center"
                >
              ...
              <motion.div 
                variants={itemVariants}
                className="mt-10 flex flex-col sm:flex-row items-center gap-4 pt-6 border-t border-gray-200"
              >
                <div className="flex -space-x-2">
                  ...
                  <span className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-white bg-primary-50 text-primary-700 text-xs font-bold">
                    +2K
                  </span>
                </div>
